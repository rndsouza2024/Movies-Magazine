...
const HomePage = () => {
    ...
    async function fetchData () {
      try {
        const [adultRes, moviesRes, tvShowRes, trailersRes] = await Promise.all(
          [
            fetch('https://123moviesmagazine.vercel.app/adult.json'),
            fetch('https://123moviesmagazine.vercel.app/movies.json'),
            fetch('https://123moviesmagazine.vercel.app/tvshow.json'),
            fetch('https://123moviesmagazine.vercel.app/trailers.json')
          ]
        )
  ...
  const pageTitle = '123 Movies Magazine™ - Explore. Discover. Download.'

  const uwatchfreeSchema = JSON.stringify([
    {
      '@context': 'https://schema.org',
      '@type': 'Organization',
      name: '123 Movies Magazine™ - Explore. Discover. Download.',
  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      {
        '@type': 'Person',
        '@id': 'https://123moviesmagazine.vercel.app/author/123movies/',
        name: 'Dr Trailer',
        url: 'https://123moviesmagazine.vercel.app/author/123movies/',
        image: {
          '@type': 'ImageObject',
        ...
        mainEntity: [
          {
            ...
            url: 'https://123moviesmagazine.vercel.app/',
            headline: '123 Movies Magazine™ - Explore. Discover. Download.',
            datePublished: '2024-01-13T13:00:00+00:00',
            dateModified: '2024-01-13T13:13:00+00:00',
            author: {
              '@type': 'Person',
    ...
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <div className='container'>
        <Head>
          ...
          <meta
            name='keywords'
            content='123 Movies Magazine, 123movies, watch free movies, watch movies online, download movies, watch full movies, watch hd movies, tvshow, watch free tvshow, watch tvshow online, download tvshow, watch full tvshow, watch hd tvshow, adult, adult movies, watch free adult, watch adult online, download adult, watch full adult, watch hd adult'
          />
          <meta
            name='description'
            content='Welcome to 123 Movies Magazine™ – Watch and enjoy HD streaming'
          />
          ...
          <meta
            property='og:title'
            content='123 Movies Magazine™ - Explore. Discover. Download.'
          />
          <meta
            property='og:description'
            content='Welcome to 123 Movies Magazine™ – Watch and enjoy HD streaming'
          />
          <meta property='og:url' content='https://123moviesmagazine.vercel.app/' />
          <meta
        ...
        >
          ...
          >
            Welcome to 123 Movies Magazine™
          </h1>
