...
const HomePage = () => {
    ...
    try {
      const [latestRes, adultRes, moviesRes, tvShowRes, trailersRes] =
        await Promise.all([
          ...
          fetch('https://123moviesgo.vercel.app/adult.json'),
          fetch('https://123moviesgo.vercel.app/movies.json'),
          fetch('https://123moviesgo.vercel.app/tvshow.json'),
          fetch('https://123moviesgo.vercel.app/trailers.json')
        ])
  ...
  const pageTitle = '123MoviesGo™ - Explore. Stream. Download.'
        ...
        mainEntity: [
          {
            ...
            url: 'https://123moviesgo.vercel.app/',
            headline: '123MoviesGo™ - Explore. Stream. Download.',
            datePublished: '2024-01-13T13:00:00+00:00',
            dateModified: '2024-01-13T13:13:00+00:00',
            author: {
              '@type': 'Person',
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <div className='container'>
        <Head>
          <title>
          123MoviesGo™ - Explore. Stream. Download. HD Movies and TV Series Free
          </title>
