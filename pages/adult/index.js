...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://123moviesmagazine.vercel.app/adult/',
  headline: 'Watch Online adult | 123 Movies Magazine™',
  url: 'https://123moviesmagazine.vercel.app/adult/',
  description:
    'Welcome to 123 Movies Magazine™ – Watch and enjoy HD streaming',
  image: 'https://123moviesmagazine.vercel.app/og_image.jpg',
  author: {
    '@type': 'Person',
    name: 'DrTrailer',
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'adult',
      item: 'https://123moviesmagazine.vercel.app/adult/'
    }
  ]
})
...
const adultPage = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> Watch Online Adult Movies | 123 Movies Magazine™</title>
        <link rel='canonical' href='https://123moviesmagazine.vercel.app/adult/' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Watch Online Adult Movies |  123 Movies Magazine™' />
        <meta
          property='og:description'
          content='Welcome to 123 Movies Magazine™ – Watch and enjoy HD streaming'
        />

        <meta property='og:url' content='https://123moviesmagazine.vercel.app/adult' />

        <meta property='og:site_name' content='123 Movies Magazine' />
        ...
        <meta
          name='keywords'
          content='123 Movies Magazine, 123movies, adult, adult movies, watch free adult, watch adult online, download adult, watch full adult, watch hd adult'
        />
        <meta
          property='og:image'
          content='https://123moviesmagazine.vercel.app/og_image.jpg'
