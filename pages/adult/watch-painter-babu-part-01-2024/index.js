...
const adultDetail = ({ adult }) => {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch('https://123moviesgo.vercel.app/adult.json')
  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      {
        '@type': 'Person',
        '@id': 'https://123moviesgo.vercel.app/author/azmovies/',
        name: 'Dr Trailer',
        url: 'https://123moviesgo.vercel.app/author/azmovies/',
        image: {
          '@type': 'ImageObject',
      ...
      },
      {
        ...
        headline: ` ${adult.name} |  123MoviesGo™`,
        datePublished: adult.datePublished,
        dateModified: adult.dateModified,
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch Painter Babu Part 01 (2024) | 123MoviesGo™</title>
        ...
        <meta
          property='og:title'
          content={`${adult && adult.name} -  123MoviesGo`}
        />
        <meta
...
export async function getServerSideProps () {
  const res = await fetch('https://123moviesgo.vercel.app/adult.json')
