  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        url: adult.siteurl,
        name: `${adult.name} | 123 Movies Magazine™`,
      ...
      },
      {
        ...
        headline: ` ${adult.name} | 123 Movies Magazine™`,
        datePublished: adult.datePublished,
        dateModified: adult.dateModified,
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> Watch Gili Gili Raat (2024) | 123 Movies Magazine™</title>
        ...
        <meta
          property='og:title'
          content={`${adult && adult.name} - 123 Movies Magazine`}
        />
        <meta
...
export async function getServerSideProps () {
  const res = await fetch('https://123moviesmagazine.vercel.app/adult.json')
