...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://123moviesmagazine.vercel.app/tvshow/',
  headline: 'Watch Online Tvshow | 123 Movies Magazine™',
  url: 'https://123moviesmagazine.vercel.app/tvshow/',
  description:
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'Tvshow',
      item: 'https://123moviesmagazine.vercel.app/tvshow/'
    }
  ]
})
...
const tvshowPage = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> Watch Tvshow | 123 Movies Magazine™</title>
        <link rel='canonical' href='https://123moviesmagazine.vercel.app/tvshow/' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Watch Tvshow |  123 Movies Magazine™' />
        <meta
          property='og:description'
          content='Welcome to 123 Movies Magazine™ – Watch and enjoy HD streaming'
        />

        <meta property='og:url' content='https://123moviesmagazine.vercel.app/tvshow' />
        ...
        <meta
          name='keywords'
          content='123movies, 123 Movies Magazine, tvshow, watch free tvshow, watch tvshow online, download tvshow, watch full tvshow, watch hd tvshow'
        />
        <meta
          property='og:image'
          content='https://123moviesmagazine.vercel.app/og_image.jpg'
