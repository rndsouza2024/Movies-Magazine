  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        url: tvshow.siteurl,
        name: `${tvshow.name} | 123 Movies Magazine™`,
      ...
      },
      {
        ...
        headline: ` ${tvshow.name} | 123 Movies Magazine™`,
        datePublished: tvshow.datePublished,
        dateModified: tvshow.dateModified,
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Heeramandi: The Diamond Bazaar Season 1 (2024) | 123 Movies Magazine™</title>
        ...
        <meta
          property='og:title'
          content={`${tvshow && tvshow.name} - 123 Movies Magazine™`}
        />
        <meta
...
export async function getServerSideProps() {
  const res = await fetch("https://123moviesmagazine.vercel.app/tvshow.json");
