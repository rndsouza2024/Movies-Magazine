...
const moviespage1 = ({ moviesItem }) => {
  ...
  useEffect(() => {
    const detectMobileDevice = () => {
      ...
      const mobile = Boolean(
        userAgent.match(
          /Android|iPhone|iPad|iPod|Opera Mini|IEMobile|WPmobile/i
        )
      )
  ...
  }, [moviesItem, enableNoiseCancellation])
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title> {moviesItem && moviesItem.name} | Movies Magazine.</title>
        ...
        <meta name='keywords' content={`${moviesItem && moviesItem.keywords}`} />
          ...
          <div className='category-container'>
            ...
            >
              ...
              <p className='text-black text-bg font-semibold mt-2'>
                Version: {moviesItem.version}
              </p>
              <p className='text-black text-bg font-semibold mt-2'>
                Developers: {moviesItem.developers}
              </p>
              <p className='text-black text-bg font-semibold mt-2'>
                License: {moviesItem.license}
              </p>
              <div
                  ...
                  <>
                    ...
                    >
                      ...
                      <iframe
                        ...
                        ref={audioIframeRef}
                        id='audioIframe'
                        src={`https://geo.dailymotion.com/player/xjrxe.html?video=${moviesItem.videoitem}&mute=true&Autoquality=1080p`}
                        width='100%'
                        height='100%'
                        allowfullscreen
              ...
              <div className='flex flex-col items-center justify-center'>
                <p className='bg-gradient-to-r from-amber-500 to-pink-500 font-bold py-3 px-6 rounded-lg shadow-lg hover:from-amber-600 hover:to-pink-600 transition duration-300  text-bg text-black text-bg  mt-2 text-3xl mb-2 items-center justify-center '>
                  <strong> {moviesItem.head3} </strong>
                </p>
              </div>
              <Image
              ...
              <div className='flex flex-col items-center justify-center'>
                <p className='bg-gradient-to-r from-amber-500 to-pink-500 font-bold py-3 px-6 rounded-lg shadow-lg hover:from-amber-600 hover:to-pink-600 transition duration-300  text-bg text-black text-bg  mt-2 text-3xl mb-2 items-center justify-center '>
                  <strong> {moviesItem.head4} </strong>
                </p>
              </div>
              {moviesItem.news4.split('\n\n').map((paragraph, idx) => (
                <p
                  key={idx}
                  className='description text-black font-bold mt-2 text-xl'
                  style={{
...
export async function getStaticProps ({ params }) {
  const moviesItem = moviesp1Data.find(item => item.id === params.id)
