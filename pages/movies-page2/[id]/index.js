  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        name: `${moviesp2Item.name} | 123 Movies Magazine™.`,
      ...
      },
      {
        ...
        headline: `Download ${moviesp2Item.name} | 123 Movies Magazine™.`,
        datePublished: moviesp2Item.datePublished,
        dateModified: moviesp2Item.dateModified,
        articleSection: 'Movies',
        author: {
          '@id': 'https://123moviesmagazine.vercel.app/author/moviesp2Item/'
        },
        publisher: {
          '@id': 'https://gravatar.com/drmovies2022/#person'
        },
        ...
        name: `Download ${moviesp2Item.name} | 123 Movies Magazine™.`,
        isPartOf: {
          '@id': `${moviesp2Item.siteurl}#webpage`
        },
        inLanguage: 'en-US',
  ...
  return (
    <div>
      <Head>
        ...
        <meta
          property='og:title'
          content={`${moviesp2Item && moviesp2Item.name} - 123 Movies Magazine™.`}
        />
        <meta
