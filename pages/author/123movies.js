    ...
    return (
        <div className={`w-full bg-gray-600 shadow`}>
            <Head>
                ...
                <title>123 Movies Magazine - Explore. Discover. Download.</title>
            ...
            <div id="main">
                <h1 className="flex flex-col text-center py-5 font-bold text-3xl items-center justify-center" style={{ color: "#40D7BC", textShadow: "5px 5px 2px #000" }}>123 Movies Magazine - Explore. Discover. Download. </h1>
