  ...
  return (
    <div>
      <Head>
        ...
        <title>
          {' '}
          Official Trailer {trailerItem && trailerItem.name} | Movies Magazine.
        </title>
            ...
            >
              ...
              >
                 <iframe
                  ...
                  // ref={audioIframeRef}
                  // id='audioIframe'
                  src={`https://geo.dailymotion.com/player/xkdl0.html?video=${trailerItem.videoitem}&mute=true&loop=true&autoplay=1&quality=1080`}
                  width='100%'
                  height='100%'
                  allowfullscreen
