...
const softwareSchema = JSON.stringify({
  ...
  headline: 'Watch Online Movies | 123 Movies Magazine™',
...
const moviesPage = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> Watch Online Movies | 123 Movies Magazine™</title>
        <link rel='canonical' href='https://123moviesmagazine.vercel.app/movies/' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Watch Online Movies |  123 Movies Magazine™' />
        <meta
          property='og:description'
          content='Welcome to 123 Movies Magazine™ – Watch and enjoy HD streaming'
        />

        <meta property='og:url' content='https://123moviesmagazine.vercel.app/movies' />
        ...
        <meta
          name='keywords'
          content='123movies, 123 Movies Magazine, movies, watch free movies, watch movies online, download movies, watch full movies, watch hd movies'
        />
        <meta
          property='og:image'
          content='https://123moviesmagazine.vercel.app/og_image.jpg'
