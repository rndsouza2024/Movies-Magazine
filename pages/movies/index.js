...
const softwareSchema = JSON.stringify({
  ...
  'headline': 'Movies Review | Movies Magazine.™',
  'url': 'https://moviesmagazine.onrender.com/movies/',
  'description': 'Explore. Discover. Connect. - Discover your next favorite movie today!',
...
const moviesPage = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
       <Head>
        <title> Movies Review | Movies Magazine.</title>
