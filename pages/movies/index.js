...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://123moviesgo.vercel.app/movies/',
  headline: 'Watch Online movies | 123MoviesGo™',
  url: 'https://123moviesgo.vercel.app/movies/',
  description:
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'movies',
      item: 'https://123moviesgo.vercel.app/movies/'
    }
  ]
})
...
const moviesPage = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> Watch Online Movies | 123MoviesGo™</title>
        <link rel='canonical' href='https://123moviesgo.vercel.app/movies/' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content='Watch Online Movies | 123MoviesGo™' />
       ...
       <meta name="description" content="Stream HD movies and TV series for free on 123MoviesGo. Explore, stream, and download full-length movies and shows in HD quality without registration."/>
        ...
        <meta property='og:url' content='https://123moviesgo.vercel.app/movies' />
