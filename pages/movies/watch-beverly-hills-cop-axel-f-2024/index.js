  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        url: movie.siteurl,
        name: `${movie.name} | 123 Movies Magazine™`,
      ...
      },
      {
        ...
        headline: ` ${movie.name} | 123 Movies Magazine™`,
        datePublished: movie.datePublished,
        dateModified: movie.dateModified,
  ...
  return (
    <div>
      <Head>
        ...
        <title>Watch Movie Beverly Hills Cop Axel F (2024) | 123 Movies Magazine™</title>
        ...
        <meta
          property='og:title'
          content={`${movie && movie.name} - 123 Movies Magazine™`}
        />
        <meta
