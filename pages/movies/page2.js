...
const softwareSchema = JSON.stringify({
  ...
  headline: '123 Movies Magazine™ - Explore. Discover. Watch.',
...
const moviesPage1 = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> 123 Movies Magazine™ - Movies Section.</title>
        <link
          rel='canonical'
          href='https://123moviesmagazine.vercel.app/movies/page2'
        />
        <meta
          name='robots'
        ...
        <meta
          property='og:title'
          content='  123 Movies Magazine™ - Explore. Discover. Watch.'
        />
        <meta
        ...
        <meta
          property='og:url'
          content='https://123moviesmagazine.vercel.app/movies/page2'
        />
