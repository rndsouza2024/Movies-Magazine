...
const latestDetail = ({ latest }) => {
  ...
  const enhancedParagraph = (text) => {
    const linkTargets = [
      { text: 'Watch Online Wild Wild Punjab', url: 'https://123moviesgo.vercel.app/movies/watch-wild-wild-punjab-2024' },
      { text: 'Watch The Killer Trailer', url: 'https://123moviesgo.vercel.app/trailers/watch-the-killer-official-trailer-2024' },
      { text: 'JWM Trailers', url: 'https://123moviesgo.vercel.app/trailers/' },
      { text: 'JWM Movies', url: 'https://123moviesgo.vercel.app/movies/' },
      { text: 'JWM TV Series s', url: 'https://123moviesgo.vercel.app/yvshow/' },
      { text: 'JWM Adult Content', url: 'https://123moviesgo.vercel.app/adult/' },
  ...
  const uwatchfreeSchema = JSON.stringify([
    {
      ...
      image: [
        'https://123moviesgo.vercel.app/favicon.ico'
      ],
      logo: {
        '@type': 'ImageObject',
    ...
    },
    {
      ...
      potentialAction: {
        ...
        target: {
          '@type': 'EntryPoint',
          urlTemplate:
            'https://123moviesgo.vercel.app/search?q={search_term_string}'
        },
  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        name: 'Dr Trailer',
        url: 'https://123moviesgo.vercel.appauthor/justwatchfree/',
        image: {
          '@type': 'ImageObject',
      ...
      },
      {
        ...
        author: {
          '@id': 'https://123moviesgo.vercel.appauthor/justwatchfree/'
        },
        publisher: {
          '@id': 'https://gravatar.com/drtrailer2022/#person'
        },
        description: `123MoviesGo™ - Explore. Stream. Download. Stream online HD movies with Google Translate for access in any language, worldwide.`,
        image: latest.image,
        name: ` ${latest.name} | JWF™`,
        isPartOf: {
          '@id': `/${latest['latest.watch']}#webpage`
    ...
    <div>
      <Head>
        ...
        <meta
          ...
          content='123MoviesGo™ - Explore. Stream. Download. Stream online HD movies with Google Translate for access in any language, worldwide.'
        />
