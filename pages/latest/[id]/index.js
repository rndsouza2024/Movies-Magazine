  ...
  const uwatchfreeSchema = JSON.stringify([
    {
      ...
      image: [
        'https://123moviesmagazine.vercel.app/favicon.ico'
      ],
      logo: {
        '@type': 'ImageObject',
  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        name: `${latest.name} | 123 Movies Magazine`,
      ...
      },
      {
        ...
        name: 'Dr Trailer',
        url: 'https://123moviesmagazine.vercel.appauthor/123movies/',
        image: {
          '@type': 'ImageObject',
      ...
      },
      {
        ...
        headline: ` ${latest.name} | 123 Movies Magazine`,
        datePublished: '2024-01-13T13:00:00+00:00',
        dateModified: '2024-01-13T13:13:00+00:00',
        articleSection: 'latest',
        author: {
          '@id': 'https://123moviesmagazine.vercel.appauthor/123movies/'
        },
        publisher: {
          '@id': 'https://gravatar.com/drtrailer2022/#person'
        },
  ...
  return (
    <div>
      <Head>
        ...
        <meta
          property='og:title'
          content={`${latest && latest.name} - 123 Movies Magazine`}
        />
