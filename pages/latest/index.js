...
const softwareSchema = JSON.stringify({
  ...
  headline: 'Download Latest | 123 Movies Magazine™',
...
const latestPage = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> Entertainment News | 123 Movies Magazine™</title>
        ...
        <meta property='og:title' content=' Latest Blog | 123 Movies Magazine' />
        <meta
      ...
      >
        123 Movies Magazine Latest Entertainment Section.
      </h1>
      {/* <Marquee /> */}
      {/* <p
