...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://123moviesgo.vercel.app/latest/',
  headline: 'Entertainment News | 123MoviesGo™',
  url: 'https://123moviesgo.vercel.app/latest/',
  description:
  ...
  image: 'https://123moviesgo.vercel.app/wp-content/uploads/browser.webp',
  author: {
    '@type': 'Person',
    name: 'DrTrailer',
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      item: 'https://123moviesgo.vercel.app/latest/'
    }
  ]
})
...
const latestPage = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> Entertainment News | 123MoviesGo™</title>
        <link rel='canonical' href='https://123moviesgo.vercel.app/latest/' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Entertainment News | 123MoviesGo™' />
        ...
        <meta
          property='og:url'
          content='https://123moviesgo.vercel.app/latest'
        />
 ...
 <SocialSharing />
      ...
      >
        123MoviesGo™ - Latest Entertainment Section.
      </h1>
      {/* <Marquee /> */}
      {/* <p
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://123moviesgo.vercel.app/latest.json')
