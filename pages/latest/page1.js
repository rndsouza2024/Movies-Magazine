...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://moviesmagazine.onrender.com/latest-page1/',
  headline: ' Latest Blog | Movies Magazine™',
  url: 'https://moviesmagazine.onrender.com/latest-page1/',
  description:
    'Movies Magazine is the top platform for exploring and downloading software,the premier platform for the Latest Blog releases and secure downloads.',
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 3,
      name: 'Latest Page 1',
      item: 'https://moviesmagazine.onrender.com/latest-page1/'
    }
  ]
})
...
const latestpage1Page = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title>  Latest Blog | Movies Magazine™</title>
        <link rel='canonical' href='https://moviesmagazine.onrender.com/latest-page1/' />
        <meta
          name='robots'
        ...
        <meta
          ...
          content='Movies Magazine is the top platform for exploring and downloading software,the premier platform for the latest-page1 releases and secure downloads.'
        />

        <meta
          property='og:url'
          content='https://moviesmagazine.onrender.com/latest-page1'
        />
      ...
      >
        Movies Magazine Latest Blog Blog Section.
      </h1>
      <Marquee />
      {/* <p
...
export async function getStaticProps () {
  try {
    const res = await fetch('https://moviesmagazine.onrender.com/latestp1.json')
