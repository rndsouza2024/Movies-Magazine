...
const cookiepolicy = () => {
  ...
  return (
    <div>
      <Head>
        <title>123 Movies Magazine | Cookie Policy</title>
        <link
          rel='sitemap'
        ...
        <meta property='og:title' content='123 Movies Magazine ' />
        <meta
        ...
        <meta name='application-name' content='123 Movies Magazine ' />
        <meta
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap' }}>
            ...
            >
              ...
              <p style={{ color: '#666', marginBottom: '24px' }}>
                This is the Cookie Policy for 123 Movies Magazine, accessible from
