  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        name: '123movies - Explore. Discover. Connect..',
    ...
    <div>
       <Head>
        ...
        <link
          ...
          <meta
            name='keywords'
            content='123movies, 123 Movies Magazine, a-z movies, az movies, watch free movies, watch movies online, download movies, watch full movies, watch hd movies'
          />
  ...
  <div className="flex flex-wrap">
    <div className="grow-0 shrink-0 basis-auto mb-12 md:mb-0 w-full  px-3 lg:px-6">
     ...
     2. As otherwise described to you at the point of collection or with your consent.  
      ...
      We do not make warranties that this site will operate error free. If you see an error, please contact the <a className="font-bold text-blue-500 mb-6" href="mailto:ytmagpublisher@outlook.com ">webmaster</a>. By entering this site you agree to hold the owners, employees, advertisers of 123movies  free from any and all liability.This site (123movies ) do not offer any membership.If you have any questions please feel free to <a className="font-bold text-blue-500 mb-6" href="mailto:ytmagpublisher@outlook.com">contact us</a>.
      </p>
    </div>
