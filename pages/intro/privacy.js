...
const Privacy = () => {
  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      {
        '@type': 'Person',
        '@id': 'https://123moviesgo.vercel.app/author/ytmag/',
        name: 'Dr Trailer',
        url: 'https://123moviesgo.vercel.app/author/ytmag/',
        image: {
          '@type': 'ImageObject',
      ...
      {
        '@type': 'Organization',
        '@id': 'https://123moviesgo.vercel.app/#organization',
      ...
      },
      {
        ...
        potentialAction: {
          '@type': 'SearchAction',
          target: 'https://123moviesgo.vercel.app/?s={search_term_string}',
          'query-input': 'required name=search_term_string'
        }
      },
      {
        '@type': 'WebPage',
        '@id': 'https://123moviesgo.vercel.app/#webpage',
        url: 'https://123moviesgo.vercel.app/',
        name: 'Movie',
        ...
        mainEntity: [
          {
            '@type': 'Article',
            '@id': 'https://123moviesgo.vercel.app/',
            url: 'https://123moviesgo.vercel.app/',
            headline: 'Movie',
            datePublished: '2024-01-13T13:00:00+00:00',
            dateModified: '2024-01-13T13:13:00+00:00',
  ...
  return (
    <div>
       <Head>
        <title>123MoviesGo™ | Privacy Policy</title>
        ...
        <link
          ...
          />
          <link rel='canonical' href='https://123moviesgo.vercel.app/privacy/' />
          ...
          />
          <meta property='og:url' content='https://123moviesgo.vercel.app/privacy/' />
          <meta
...
<section className="mb-32 text-gray-800">
  <div className="flex flex-wrap">
    <div className="grow-0 shrink-0 basis-auto mb-12 md:mb-0 w-full  px-3 lg:px-6">
      ...
      <p className="font-bold mb-2">123MoviesGo™ </p>
      <p className="text-gray-500 mb-6">
      123MoviesGo™ International(123MoviesGo™) is committed to protecting your privacy. This Privacy Policy applies only to the Web Sites and applications published by 123MoviesGo™ International.
      </p>
      <p className="font-bold mb-2">Note: Use of Information</p>
      <p className="text-gray-500 mb-6">
      Information that we collect  </p>
      <p className="text-gray-500 mb-6">
      123MoviesGo™ may collect information from its users in three different ways: directly from the user, from traffic references of hostingservers and from cookies.
      </p>
     ...
     2. As otherwise described to you at the point of collection or with your consent.  
      ...
      We do not make warranties that this site will operate error free. If you see an error, please contact the <a className="font-bold text-blue-500 mb-6" href="mailto:ytmagpublisher@outlook.com ">webmaster</a>. By entering this site you agree to hold the owners, employees, advertisers of 123MoviesGo™  free from any and all liability.This site (123MoviesGo™ ) do not offer any membership.If you have any questions please feel free to <a className="font-bold text-blue-500 mb-6" href="mailto:ytmagpublisher@outlook.com">contact us</a>.
      </p>
    </div>
