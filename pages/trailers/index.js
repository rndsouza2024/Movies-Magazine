...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://123moviesmagazine.vercel.app/trailers/',
  headline: 'Watch Online Trailers | A to Z Trailers™',
  url: 'https://123moviesmagazine.vercel.app/trailers/',
  description:
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'Trailers',
      item: 'https://123moviesmagazine.vercel.app/trailers/'
    }
  ]
})
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        ...
        <link rel='canonical' href='https://123moviesmagazine.vercel.app/trailers/' />
        <meta
          name='robots'
        ...
        <meta property='og:url' content='https://123moviesmagazine.vercel.app/trailers' />
