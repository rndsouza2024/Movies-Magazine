...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://123moviesgo.vercel.app/trailers/',
  headline: 'Watch Online Trailers | 123MoviesGo™',
  url: 'https://123moviesgo.vercel.app/trailers/',
  description:
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'Trailers',
      item: 'https://123moviesgo.vercel.app/trailers/'
    }
  ]
})
...
const trailersPage = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
      <Head>
        <title> Watch Latest Trailers | 123MoviesGo™</title>
        <link rel='canonical' href='https://123moviesgo.vercel.app/trailers/' />
        <meta
          name='robots'
        ...
        <meta property='og:title' content=' Watch Latest Trailers | 123MoviesGo™' />
       ...
       <meta name="description" content="Stream HD movies and TV series for free on 123MoviesGo. Explore, stream, and download full-length movies and shows in HD quality without registration."/>
        ...
        <meta property='og:url' content='https://123moviesgo.vercel.app/trailers' />
