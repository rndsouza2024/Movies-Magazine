...
const trailersDetail = ({ trailers }) => {
  ...
  const fetchData = async () => {
    try {
      const response = await fetch('https://123moviesgo.vercel.app/trailers.json')
  ...
  const rankMathSchema = JSON.stringify({
    ...
    '@graph': [
      ...
      },
      {
        ...
        name: `${trailers.name} | 123MoviesGo™`,
      ...
      },
      {
        ...
        headline: ` ${trailers.name} | 123MoviesGo™`,
        datePublished: trailers.datePublished,
        dateModified: trailers.dateModified,
  ...
  return (
    <div>
      <Head>
        ...
        />
        <title>Watch Time Bandits Season 1 Official Trailer | 123MoviesGo™</title>
        ...
        <meta
          property='og:title'
          content={`${trailers && trailers.name} - 123MoviesGo™`}
        />
        <meta
...
export async function getServerSideProps () {
  const res = await fetch('https://123moviesgo.vercel.app/trailers.json')
