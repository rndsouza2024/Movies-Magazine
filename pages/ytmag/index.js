...
const softwareSchema = JSON.stringify({
  '@context': 'https://schema.org',
  '@type': 'Article',
  '@id': 'https://softwarebay.vercel.app/ytmag/',
  'headline': 'Download ytmag | Softwarebay™',
  'url': 'https://softwarebay.vercel.app/ytmag/',
  ...
  'image': 'https://softwarebay.vercel.app/wp-content/uploads/ytmag.webp',
  'author': {
    '@type': 'Person',
    'name': 'DrTrailer',
...
const breadcrumbSchema = JSON.stringify({
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'ytmag',
      item: 'https://softwarebay.vercel.app/ytmag/'
    }
  ]
})

const ytmagPage = ({ items }) => {
  ...
  return (
    <div className='w-full' style={{ backgroundColor: '#D3D3D3' }}>
       <Head>
        <title> Download ytmag | Softwarebay</title>
        <link rel='canonical' href="https://softwarebay.vercel.app/ytmag/" />
        <meta
          name='robots'
       ...
       <meta name='robots' content='index, follow' />
        ...
        <meta
          property='og:title'
          content=" Download ytmag | Softwarebay"
        />
        <meta
        ...
        <meta property='og:url' content= "https://softwarebay.vercel.app/ytmag"/>
       
        <meta property='og:site_name' content='Softwarebay' />
        <meta property='og:type' content='article' />
        <meta
          property=' og:image:alt'
          content= "https://softwarebay.vercel.app/wp-content/uploads/ytmag.webp"
        />
        ...
        />
          <meta name='keywords' content="download, software, freeware, shareware, trial versions, program, utilities, security, network, multimedia, ytmag, mobile, games, graphic design, file sharing, education, development, desktop, browser" />
        <meta
          property='og:image'
          content= "https://softwarebay.vercel.app/wp-content/uploads/ytmag.webp"  />
...
{/* <p
      ...
      <div className='container'>
        {/* <h1  className='px-0 font-black bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent'>ytmag Section</h1> */}
        <div className='flex-container'>
          ...
          <div key={item.id}>
            ...
            <Pagination currentPage={currentPage} totalPages={totalPages} route="ytmag" />
          </div>
...
export async function getStaticProps() {
  try {
    const res = await fetch('https://softwarebay.vercel.app/ytmag.json');
